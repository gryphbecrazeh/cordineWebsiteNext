...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  return __jsx(_layouts_document__WEBPACK_IMPORTED_MODULE_7__["default"], null, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_2__["Row"], null, __jsx("header", null, __jsx(_components_CenteredHeading__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    className: "accent elite"
  }, "Featured Work"), __jsx("p", {
    className: "elite"
  }, "I like to be constantly busy, and frequently work on several projects at a time, and am always writing, working out ideas, and prototyping for proof of concept. I've listed a few of my favorite work below. These range from a basic HTML and CSS templating, to", " ", __jsx("em", {
    className: "accent"
  }, "full stack applications"), " with a clear goal in mind."), __jsx("p", {
    className: "elite"
    ...
    className: "elite"
  }, "Below you will find a lot of front end work that I have found fun and interesting, most of which being CSS and Bootstrap renditions of mockups I've made or found online. For more advanced front end work, feel free to check out my front-end-only react, and full MERN stack projects", " ", __jsx("a", {
    className: "accent",
    href: "/projects"
  }, "here"), "."))));
});
...
//# sourceMappingURL=index.js.5d149eca5eb9cf47244f.hot-update.js.map